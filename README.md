...
# Importar proyectos a GitHub

**Creación de rama principal**

- git init | *Iniciar git dentro del proyecto*
- git branch -M main | *Crear rama principal dentro del repositorio local*

**Agregar cambios al repositorio remoto**

- git remote add origin URL-HTTPS-GITHUB | *Se agrega al repositorio remoto con la URL obtenida al crear un nuevo repositorio en GitHub*
- git push -u origin main | *Subir y vincular los cambios del repositorio local al repositorio remoto*
